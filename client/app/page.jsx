      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-600 rounded-3xl mb-6">
            <span className="text-3xl font-bold text-white">QC</span>
          </div>
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to QuickCourt</h1>
          <p className="text-gray-600 mb-8 text-lg">Your local sports booking platform</p>
          <div className="space-y-4">
            <Link
              href="/auth/login"
              className="block w-full bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all transform hover:scale-[1.02]"
            >
              Sign In
            </Link>
            <Link
              href="/auth/signup"
              className="block w-full border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 transition-all"
            >
              Sign Up
            </Link>
          </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-700 text-sm">View your upcoming games</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-700 text-sm">Update your preferences</p>
                  </div>
                </div>
              </Link>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-12">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Venues Near You</h2>
                <p className="text-gray-600 text-lg">Top-rated sports facilities in your area</p>
              </div>
              <Link
                href="/venues"
